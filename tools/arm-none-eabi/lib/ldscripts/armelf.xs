...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/build/gnu-tools-for-stm32_11.3.rel1.20230912-1600/install-native/arm-none-eabi/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
